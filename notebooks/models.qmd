...
df_summary_f1['precision'].mean().round(3)
df_summary_f1['recall'].mean().round(3)
df_summary_f1['f1_score'].mean().round(3)
...
dir_txt_files = here("data/intermediate/predicted_all_tiles/batch8_imgsz256/predict/labels")

results = text_to_dataframe(dir_txt_files)
...
df_grid_new = df_grid.merge(df_results_confidence, on="tile_id", how="left")
